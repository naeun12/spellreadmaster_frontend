...
import RecentActivities from '../components/TeacherDashboard/RecentActivities';
...
function TeacherPage() {
  ...
  return (
    <TeacherLayout>
      ...
      <div className="bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 rounded-2xl p-8 mb-6 ml-6 mr-6 shadow-lg relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-sm mt-2 max-w-2xl">{"Welcome back! Here's what's happening with your students today."}</p>
        </div>
      </div>
